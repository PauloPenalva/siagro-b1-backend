...
namespace SiagroB1.Migrations.AppContext
{
    ...
    [Migration("20260921211607_AddShipmentLoadTransshipments")]
    partial class AddShipmentLoadTransshipments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.SalesInvoiceItem", b =>
                {
                    ...
                    b.Property<decimal>("TicketDeliveredQuantity")
                        .HasColumnType("DECIMAL(18,3) DEFAULT 0");
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.ShipmentLoad", b =>
                {
                    ...
                    b.Property<string>("CarrierCardCode")
                        .HasColumnType("VARCHAR(10)");
                    ...
                    b.Property<decimal>("ReturnedToWarehouseQuantity")
                        .HasColumnType("DECIMAL(18,3) DEFAULT 0");
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.ShipmentLoadAttachment", b =>
                {
                    b.Property<Guid>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SHIPMENT_LOAD_ATTACHMENTS");
                });

            modelBuilder.Entity("SiagroB1.Domain.Entities.ShipmentLoadChangeLog", b =>
                {
                    b.Property<Guid>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SHIPMENT_LOADS_CHANGE_LOGS");
                });

            modelBuilder.Entity("SiagroB1.Domain.Entities.ShipmentLoadComment", b =>
                {
                    b.Property<Guid>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SHIPMENT_LOADS_COMMENTS");
                });

            modelBuilder.Entity("SiagroB1.Domain.Entities.ShipmentLoadDischarge", b =>
                {
                    b.Property<Guid>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SHIPMENT_LOAD_DISCHARGES");
                });
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.ShipmentRelease", b =>
                {
                    ...
                    b.Property<Guid?>("GeneratedByStorageTransactionKey")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GeneratedByStorageTransactionKey");
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.ShippingReleaseChange", b =>
                {
                    b.Property<Guid>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("NewPurchaseStorageTransactionKey")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("NewQuantity")
                        .HasColumnType("DECIMAL(18,3)");

                    b.Property<Guid>("NewSalesStorageTransactionKey")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("OperationGroupKey")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("OriginalPurchaseStorageTransactionKey")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("OriginalQuantity")
                        .HasColumnType("DECIMAL(18,3)");

                    b.Property<Guid>("OriginalSalesStorageTransactionKey")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ReturnPurchaseStorageTransactionKey")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ReturnSalesStorageTransactionKey")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("SourceShipmentReleaseKey")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("TargetShipmentReleaseKey")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("NewPurchaseStorageTransactionKey");

                    b.HasIndex("NewSalesStorageTransactionKey");

                    b.HasIndex("OperationGroupKey");

                    b.HasIndex("OriginalPurchaseStorageTransactionKey");

                    b.HasIndex("OriginalSalesStorageTransactionKey");

                    b.HasIndex("ReturnPurchaseStorageTransactionKey");

                    b.HasIndex("ReturnSalesStorageTransactionKey");

                    b.HasIndex("ShipmentLoadKey");

                    b.HasIndex("SourceShipmentReleaseKey");

                    b.HasIndex("TargetShipmentReleaseKey");

                    b.ToTable("SHIPPING_RELEASE_CHANGES");
                });
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.StorageTransaction", b =>
                {
                    ...
                    b.Property<Guid?>("GeneratedByReturnInvoiceKey")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("RefusedFromShipmentLoadKey")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ReplacedByShippingReleaseChangeKey")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ShippingReleaseChangeKey")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GeneratedByReturnInvoiceKey");

                    b.HasIndex("OwnershipTransferKey");

                    b.HasIndex("ProcessingCostCode");

                    b.HasIndex("RefusedFromShipmentLoadKey");

                    b.HasIndex("ReplacedByShippingReleaseChangeKey");
                    ...
                    b.HasIndex("ShippingReleaseChangeKey");
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.WarehouseReconciliationRelease", b =>
                {
                    b.Property<Guid>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("LossStorageTransactionKey")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("WarehouseReconciliationKey", "ShipmentReleaseKey")
                        .IsUnique();

                    b.ToTable("WAREHOUSE_RECONCILIATION_RELEASES");
                });
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.ShipmentLoadDischarge", b =>
                {
                    b.HasOne("SiagroB1.Domain.Entities.ShipmentLoadAttachment", "Attachment")
                        .WithMany()
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.ShipmentRelease", b =>
                {
                    ...
                    b.HasOne("SiagroB1.Domain.Entities.StorageTransaction", "GeneratedByStorageTransaction")
                        .WithMany()
                        .HasForeignKey("GeneratedByStorageTransactionKey")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("GeneratedByStorageTransaction");
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.ShippingReleaseChange", b =>
                {
                    b.HasOne("SiagroB1.Domain.Entities.StorageTransaction", null)
                        .WithMany()
                        .HasForeignKey("NewPurchaseStorageTransactionKey")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SiagroB1.Domain.Entities.StorageTransaction", null)
                        .WithMany()
                        .HasForeignKey("NewSalesStorageTransactionKey")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SiagroB1.Domain.Entities.StorageTransaction", null)
                        .WithMany()
                        .HasForeignKey("OriginalPurchaseStorageTransactionKey")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SiagroB1.Domain.Entities.StorageTransaction", null)
                        .WithMany()
                        .HasForeignKey("OriginalSalesStorageTransactionKey")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SiagroB1.Domain.Entities.StorageTransaction", null)
                        .WithMany()
                        .HasForeignKey("ReturnPurchaseStorageTransactionKey")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SiagroB1.Domain.Entities.StorageTransaction", null)
                        .WithMany()
                        .HasForeignKey("ReturnSalesStorageTransactionKey")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SiagroB1.Domain.Entities.ShipmentLoad", null)
                        .WithMany()
                        .HasForeignKey("ShipmentLoadKey")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SiagroB1.Domain.Entities.ShipmentRelease", null)
                        .WithMany()
                        .HasForeignKey("SourceShipmentReleaseKey")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SiagroB1.Domain.Entities.ShipmentRelease", null)
                        .WithMany()
                        .HasForeignKey("TargetShipmentReleaseKey")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SiagroB1.Domain.Entities.StorageTransaction", b =>
                {
                    ...
                    b.HasOne("SiagroB1.Domain.Entities.SalesInvoice", "GeneratedByReturnInvoice")
                        .WithMany()
                        .HasForeignKey("GeneratedByReturnInvoiceKey")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.HasOne("SiagroB1.Domain.Entities.ShipmentLoad", "RefusedFromShipmentLoad")
                        .WithMany("RefusalReturns")
                        .HasForeignKey("RefusedFromShipmentLoadKey")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SiagroB1.Domain.Entities.ShippingReleaseChange", null)
                        .WithMany()
                        .HasForeignKey("ReplacedByShippingReleaseChangeKey")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.HasOne("SiagroB1.Domain.Entities.ShippingReleaseChange", null)
                        .WithMany()
                        .HasForeignKey("ShippingReleaseChangeKey")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("GeneratedByReturnInvoice");

                    b.Navigation("OwnershipTransfer");

                    b.Navigation("ProcessingCost");

                    b.Navigation("RefusedFromShipmentLoad");
