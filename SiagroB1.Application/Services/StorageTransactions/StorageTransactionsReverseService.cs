    ...
    IStringLocalizer<Resource> resource)
{
    public async Task ExecuteAsync(Guid key, string username, TransactionCode transactionCode = TransactionCode.StorageTransaction)
    {
        ...
        // GAC-1181: o romaneio de entrada pertence ao transbordo. Estorná-lo por aqui deixaria o
        // transbordo apontando um romaneio pendente e as liberações vivas.
        ...
        {
            throw new ApplicationException(
                $"O romaneio {doc.Code} faz parte de uma troca de liberação e não pode ser estornado por aqui.");
        }
