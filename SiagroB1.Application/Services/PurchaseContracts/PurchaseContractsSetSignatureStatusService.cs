...
/// <summary>
/// Altera a situação de assinatura do contrato de COMPRA. Espelho de
/// <c>SalesContractsSetSignatureStatusService</c>.
/// </summary>
/// <remarks>
...
/// (<see cref="PurchaseContractsUpdateService"/>) recusa contrato fora de Rascunho e copia a
/// entidade inteira com <c>SetValues</c>, sem como isentar uma coluna.
/// </remarks>
public class PurchaseContractsSetSignatureStatusService(
    ...
    PurchaseContractsChangeLogService changeLog)
{
    ...
    {
        var contract = await context.PurchaseContracts.FirstOrDefaultAsync(x => x.Key == key)
