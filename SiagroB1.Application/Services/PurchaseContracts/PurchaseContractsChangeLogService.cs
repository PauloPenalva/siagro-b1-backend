...
/// <summary>
/// Porta única de escrita do log de alterações do contrato de COMPRA. Espelho de
/// <c>SalesContractsChangeLogService</c>.
///
...
/// </summary>
public class PurchaseContractsChangeLogService(AppDbContext context)
{
    public void Register(
        ...
        string userName)
    {
        context.PurchaseContractsChangeLogs.Add(new PurchaseContractChangeLog
        {
