...
/// <summary>
/// Porta única de escrita do log de alterações do documento de saída.
///
...
/// </summary>
public class SalesInvoicesChangeLogService(AppDbContext context)
{
    public void Register(
        ...
        string userName)
    {
        context.SalesInvoicesChangeLogs.Add(new SalesInvoiceChangeLog
        {
