...
/// <summary>
/// Linhas de saída elegíveis como ORIGEM de uma devolução de cliente.
///
/// Elegível é a linha que: pertence ao mesmo cliente do documento, está em documento confirmado
/// (cancelado não devolve nada), teve a entrega CONFERIDA e fechada, e apurou quebra maior que
/// zero. Sem entrega fechada não há quebra apurada — o fator efetivo ainda vale 1 e não há nada
/// que o fiscal precise espelhar.
///
