...
/// <summary>
/// Regras comuns aos comentários de contrato de compra e de venda. Fica num arquivo único (e não
/// duplicada nos dois lados) porque é literalmente a mesma decisão de negócio: quem pode alterar e
/// que texto é aceito.
///
/// Note o que NÃO está aqui: guarda de status. Comentário é anotação e não altera valor, volume nem
/// saldo — é editável a qualquer tempo, inclusive em contrato encerrado ou cancelado.
/// </summary>
public static class ContractCommentRules
{
    /// <summary>
    /// Igual a <c>VARCHAR(500)</c> das colunas <c>OldValue</c>/<c>NewValue</c> do log de
