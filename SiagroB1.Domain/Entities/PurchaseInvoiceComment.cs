...
/// <summary>
/// Um comentário do documento de entrada: anotação livre com data, hora e autor, editável a
/// qualquer tempo — inclusive em documento confirmado ou cancelado, porque comentário não altera
/// valor, peso nem saldo.
///
/// Não confundir com <see cref="PurchaseInvoice.Comments"/>, o campo escalar de "Observações" do
/// cabeçalho. É por causa desse escalar que a coleção se chama
/// <see cref="PurchaseInvoice.CommentEntries"/>, e não <c>Comments</c>.
///
...
public class PurchaseInvoiceComment
{
    ...
    /// <summary>
    /// 500 caracteres para casar com <see cref="PurchaseInvoiceChangeLog.NewValue"/>: assim nenhuma
