...
public class PriceFixationsApprovalServiceTests
{
    ...
    public async Task Approve_InApprovalFixation_BecomesConfirmed_AndRecordsApprover()
    {
        ...
        await new PurchaseContractsPriceFixationsApprovalService(_db.Context, FixedVolume(), ChangeLog(), TestNotificationOutbox.For(_db.Context), FinancialDocuments())
    ...
    public async Task Approve_AlreadyConfirmed_Throws()
    {
        ...
        await Assert.ThrowsAsync<ApplicationException>(() =>
            new PurchaseContractsPriceFixationsApprovalService(_db.Context, FixedVolume(), ChangeLog(), TestNotificationOutbox.For(_db.Context), FinancialDocuments())
                .ExecuteAsync(fixation.Key, null, "diretoria"));
    }
    ...
    public async Task Reject_InApprovalFixation_BecomesRejected_AndReleasesVolume()
    {
        ...
        await new PurchaseContractsPriceFixationsRejectService(_db.Context, FixedVolume(), ChangeLog(), TestNotificationOutbox.For(_db.Context))
    ...
    public async Task Reject_AlreadyConfirmed_Throws()
    {
        ...
        await Assert.ThrowsAsync<ApplicationException>(() =>
            new PurchaseContractsPriceFixationsRejectService(_db.Context, FixedVolume(), ChangeLog(), TestNotificationOutbox.For(_db.Context))
                .ExecuteAsync(fixation.Key, null, "diretoria"));
    }
}
