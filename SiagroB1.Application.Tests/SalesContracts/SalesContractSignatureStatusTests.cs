...
/// <summary>
/// A situação de assinatura do contrato de VENDA é fato documental: vale em qualquer status,
...
/// </summary>
public class SalesContractSignatureStatusTests
{
    private readonly UnitOfWork _db = TestDb.CreateUnitOfWork();

    private SalesContractsSetSignatureStatusService Service() => new(
        _db.Context,
    ...
    private Task<List<SalesContractChangeLog>> LogsAsync(Guid key) =>
        _db.Context.SalesContractsChangeLogs
            .Where(l => l.SalesContractKey == key)
            .ToListAsync();
