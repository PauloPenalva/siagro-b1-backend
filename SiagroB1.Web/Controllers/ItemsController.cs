...
{ 
    ...
    public virtual async Task<IActionResult> Post([FromBody] ItemModel entity)
        {
        ...
        public virtual async Task<IActionResult> Put([FromRoute] string key, [FromBody] ItemModel entity)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public virtual async Task<IActionResult> Patch([FromODataUri] string key, [FromBody] Delta<ItemModel> patch)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            ItemModel? t = await service.GetByIdAsync(key);
