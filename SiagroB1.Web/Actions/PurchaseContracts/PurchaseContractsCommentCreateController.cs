...
public class PurchaseContractsCommentCreateController(
    PurchaseContractsCommentCreateService service) : ODataController
{
    [HttpPost("odata/PurchaseContractsCommentCreate")]
