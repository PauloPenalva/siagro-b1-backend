...
public class PurchaseContractsPriceFixationDeleteController(
    PurchaseContractsPriceFixationDeleteService service) : ODataController
{
    [HttpPost("odata/PurchaseContractsPriceFixationDelete")]
