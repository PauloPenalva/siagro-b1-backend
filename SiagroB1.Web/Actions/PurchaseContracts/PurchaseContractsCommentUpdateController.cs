...
public class PurchaseContractsCommentUpdateController(
    PurchaseContractsCommentUpdateService service) : ODataController
{
    /// <summary>
    ...
    /// </summary>
    [HttpPost("odata/PurchaseContractsCommentUpdate")]
