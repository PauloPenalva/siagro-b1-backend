...
public class PurchaseContractsWithdrawApprovalController(
    PurchaseContractsWithdrawApprovalService service
    ) : ODataController
{
    [HttpPost("odata/PurchaseContractsWithdrawApproval")]
