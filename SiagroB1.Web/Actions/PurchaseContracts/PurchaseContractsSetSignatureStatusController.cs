...
public class PurchaseContractsSetSignatureStatusController(
    PurchaseContractsSetSignatureStatusService service) : ODataController
{
    [HttpPost("odata/PurchaseContractsSetSignatureStatus")]
