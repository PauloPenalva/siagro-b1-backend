...
public class StorageEntryTransactionsCancelController(
    StorageEntryTransactionsCancelService service) : ODataController
{
    [HttpPost("odata/StorageEntryTransactionsCancel")]
