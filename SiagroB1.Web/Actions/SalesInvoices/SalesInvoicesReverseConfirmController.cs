...
public class SalesInvoicesReverseConfirmController(
    SalesInvoicesReverseConfirmService confirmService
    )
    :ODataController
{
    [HttpPost("odata/SalesInvoicesReverseConfirm")]
    public async Task<IActionResult> PostAsync(ODataActionParameters parameters)
    {
        ...
        try
        {
            ...
            await confirmService.ExecuteAsync(key,userName);
