...
/// <summary>
/// Cancela o documento de entrada. Não apaga: o índice único da chave de NF-e é filtrado por
/// status, então cancelar LIBERA a chave para relançamento e o rastro sobrevive.
/// </summary>
public class PurchaseInvoicesCancelController(PurchaseInvoicesCancelService service)
    : ODataController
{
    [HttpPost("odata/PurchaseInvoicesCancel")]
