...
public class SalesContractsCommentUpdateController(
    SalesContractsCommentUpdateService service) : ODataController
{
    /// <summary>
    ...
    /// </summary>
    [HttpPost("odata/SalesContractsCommentUpdate")]
