...
public class SalesContractsPriceFixationCancelController(
    SalesContractsPriceFixationsCancelService service) : ODataController
{
    [HttpPost("odata/SalesContractsPriceFixationCancel")]
