...
public class SalesContractsCommentDeleteController(
    SalesContractsCommentDeleteService service) : ODataController
{
    /// <summary>
    /// <c>Key</c> é a chave do COMENTÁRIO. O texto excluído fica no log de alterações.
    /// </summary>
    [HttpPost("odata/SalesContractsCommentDelete")]
