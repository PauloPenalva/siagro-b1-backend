...
public class SalesContractsDeleteReallocationController(SalesContractsReallocationDeleteService service)
    : ODataController
{
    [HttpPost("odata/SalesContractsDeleteReallocation")]
