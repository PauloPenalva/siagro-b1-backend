...
public class SalesShipmentReleasesReopenController(
    SalesShipmentReleasesReopenService service) : ODataController
{
    [HttpPost("odata/SalesShipmentReleasesReopen")]
