...
public class WarehouseReconciliationsRejectController(
    WarehouseReconciliationsRejectService service) : ODataController
{
    [HttpPost("odata/WarehouseReconciliationsReject")]
