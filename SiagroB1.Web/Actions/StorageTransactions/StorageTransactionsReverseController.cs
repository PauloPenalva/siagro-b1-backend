...
public class StorageTransactionsReverseController(
    StorageTransactionsReverseService service
    ) : ODataController
{

    [HttpPost("odata/StorageTransactionsReverse")]
    public async Task<IActionResult> Post(ODataActionParameters parameters)
    {
        ...
        try
        {
            ...
            await service.ExecuteAsync(key,userName, TransactionCode.WeighingTicket);
